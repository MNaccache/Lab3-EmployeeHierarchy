...
public class BasePlusCommissionEmployee {
    ...
    protected BasePlusCommissionEmployee(String firstName, String lastName,
        ...
        commissionEmployee =
        new CommissionEmployee(firstName, lastName, socialSecurityNumber,
    ...
    public String toString() {
        ...
        commissionEmployee.toString(), "base salary", getBaseSalary(), "total salary", earnings());
    }
}